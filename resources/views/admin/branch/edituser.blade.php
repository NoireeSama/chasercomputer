...
@section('content')
            ...
            <form id="editUserForm" action="{{ route('user.update', $user->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <div class="glass-pill input-wrapper">
                        <input type="text" name="username" value="{{ $user->username }}" placeholder="Masukkan username" required>
                ...
                <div class="form-group">
                    ...
                    <div class="glass-pill input-wrapper">
                        <input type="email" name="email" value="{{ $user->email }}" placeholder="Masukkan email" required>
                        <svg class="edit-icon" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path>
                        </svg>
                    </div>
                ...
                <div class="form-group center-content">
                    ...
                    <div class="custom-dropdown" id="roleDropdown">
                        ...
                        <div class="glass-pill dropdown-btn">
                            <span class="selected-text">{{ $user->role->nama ?? 'Pilih Role' }}</span>
                ...
                <div class="action-buttons">
                    ...
                    <button type="button" class="glass-pill btn-delete" onclick="if(confirm('Apakah Anda yakin ingin menghapus user ini?')) { document.getElementById('deleteForm').submit(); }">Hapus</button>
                </div>
    ...
    <form id="deleteForm" action="{{ route('user.delete', $user->id) }}" method="POST" style="display: none;">
        @csrf
        @method('DELETE')
    </form>
